...
summary_df<-points_1 %>% 
  group_by(species) %>% 
  reframe(n=n(),
          precip_maxquant=quantile(precip, 0.90), 
          precip_minquant=quantile(precip, 0.10),
          precip_mean=mean(precip),
          precip_median=median(precip),
          nitro_maxquant=quantile(nitrogen, 0.90),
          nitro_minquant=quantile(nitrogen, 0.10),
          nitro_mean=mean(nitrogen),
          nitro_median=median(nitrogen),
          temp_maxquant=quantile(temp, 0.90),
          temp_minquant=quantile(temp, 0.10),
          temp_mean=mean(temp),
...
### save df
write.csv(precip_means, "90-10_analyses/90_10_precip_EFN_breadth_means.csv")
...
### save df
write.csv(fix_precip_means, "90-10_analyses/90_10_precip_fix_breadth_means.csv")
...
### save df
write.csv(EFN_temp_means, "90-10_analyses/90_10_temp_EFN_breadth_means.csv")
...
### save df
write.csv(fix_temp_means, "90-10_analyses/90_10_temp_fix_breadth_means.csv")
...
### save df
write.csv(EFN_nitro_means, "90-10_analyses/90_10_nitro_EFN_breadth_means.csv")
...
### save df
write.csv(fix_nitro_means, "90-10_analyses/90_10_nitro_fix_breadth_means.csv")
