...
dat<-read_csv("data/invasiveclass_thindat_climadd_soilgridsadd.csv")
...
sf::st_write(join1, "data/invasiveclass_thinnedoccs_soil_clim_biome.csv", layer_options = "GEOMETRY=AS_XY")
